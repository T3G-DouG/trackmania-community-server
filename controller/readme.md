...
### Origin
This controller is based on [dassschaf/nextcontrol](https://github.com/dassschaf/nextcontrol) (GPL-3.0). This fork adds a large set of community-server features on top of it: a full plugin set for Telegram integration, a points/Hall-of-Fame system, karma-based map voting, a monthly/yearly archive system, an optional AI-assisted race commentary and analysis module, and an (in-progress, beta) cup/tournament system. See the repository root `README.md` for the full feature overview and setup instructions.
